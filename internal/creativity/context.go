...
func buildPrompt(projectCtx *ProjectContext) string {
	...
	b.WriteString("Review all documentation and code in the ./docs folder to understand the project before suggesting an improvement.\n")
	...
	b.WriteString("Always ensure documentation is up-to-date and comprehensive with the changes. Update and create the relevant documentation files in the ./docs directory.\n")
	b.WriteString("Every issue should be actionable and have a clear impact on the project.\n")
	b.WriteString("Every issue should be documented in the ./docs directory.\n")
